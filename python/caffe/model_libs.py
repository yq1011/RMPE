...
def ConvBNLayer(net, from_layer, out_layer, use_bn, use_relu, num_output,
    kernel_size, pad, stride, dilation=1, for_HG_module=False, use_scale=True, lr_mult=1, conv_prefix='', conv_postfix='',
    bn_prefix='', bn_postfix='_bn', scale_prefix='', scale_postfix='_scale',
    bias_prefix='', bias_postfix='_bias',**bn_params):
  if use_bn:
    if for_HG_module:
      kwargs = {
...
def ResBody(net, from_layer, block_name, out2a, out2b, out2c, stride, use_branch1, for_HG_module=False, dilation=1, **bn_param):
  ...
  if dilation == 1:
    ...
    ConvBNLayer(net, out_name, branch_name, use_bn=True, use_relu=True,
        ...
        dilation=dilation, conv_prefix=conv_prefix, conv_postfix=conv_postfix,for_HG_module=for_HG_module,
        bn_prefix=bn_prefix, bn_postfix=bn_postfix,
        scale_prefix=scale_prefix, scale_postfix=scale_postfix, **bn_param)
